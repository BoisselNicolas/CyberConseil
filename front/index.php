...
<head>
    ...
    <form id="msform">
        ...
        <fieldset>
            ...
            <input type="button" name="previous" class="previous action-button" value="A" />
...
require 'php/CallRestAPI.php';
$res = CallAPI('GET', $_ENV['API_URI'] . '/getQuestions');
echo $res;
?>
...
<style>
    ...
    * {margin: 0; padding: 0;}
    ...
    #progressbar li {
        ...
        text-transform: uppercase;
        font-size: 9px;
        width: 25%; /* ICI POUR CHANGER LE NOMBRE LI SUR UNE LIGNE*/
        float: left;
        position: relative;
    }
